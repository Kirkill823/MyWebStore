...
class Smarty_Internal_Compile_Include extends Smarty_Internal_CompileBase
{
    ...
    /**
     * Compiles code for the {includes} tag
     *
    ...
    public function compile($args, Smarty_Internal_SmartyTemplateCompiler $compiler)
    {
        ...
        // caching was on and {includes} is not in nocache mode
        ...
        /*
        * if the {includes} tag provides individual parameter for caching or compile_id
        ...
        */
        ...
        // delete {includes} standard attributes
